...
const steps = [
  {
    step: "01",
    title: "Answer a Few Questions About Your Store",
    description: "12 quick questions about your products, plugins, and custom features — about 2 minutes.",
    icon: ClipboardList,
  },
  {
    step: "02",
    title: "We Calculate Your Readiness Score",
    description: "Your answers are scored instantly using a fixed, disclosed formula — nothing random.",
    icon: Calculator,
  },
  {
    step: "03",
    title: "Get Your Migration Plan",
    description: "See your risks, complexity, and clear next steps for moving to Shopify.",
    icon: FileCheck2,
  },
];

export default function MigrationHowItWorks() {
  return (
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        <div className="mx-auto max-w-xl text-center">
          ...
          <h2 className="mt-4 text-[28px] font-extrabold tracking-[-0.01em] text-(--color-ink) sm:text-[34px]">
            How Our Shopify Migration Checker Works
          </h2>
        </div>
        ...
        >
          ...
          {steps.map(({ step, title, description, icon: Icon }) => (
            ...
            >
              ...
              <p className="mt-2 text-[14.5px] leading-relaxed text-(--color-ink-soft)">{description}</p>
            </motion.div>
          ))}
        </motion.div>
      </div>
