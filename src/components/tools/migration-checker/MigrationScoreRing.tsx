...
export default function MigrationScoreRing({ score, label }: MigrationScoreRingProps) {
    ...
    <div className="flex flex-col items-center">
      <div className="relative h-[132px] w-[132px]">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          <span className="text-[32px] font-extrabold leading-none text-(--color-ink)">{clamped}</span>
